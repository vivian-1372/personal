...
```{r echo = FALSE, out.width = "95%", fig.cap = 'Predictor Variable Regression Coefficients for Trust'}
...
```{r echo = FALSE, out.width = "95%", fig.cap = 'Scaled Regression Coefficients and Trust'}
...
```{r echo = FALSE, out.width = "95%", fig.cap = 'Predicted CDC Trust due to COVID Concern, by Party'}
